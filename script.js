document.addEventListener("DOMContentLoaded", () => {
  ...
  const steps = [
    // Expanded Intro
    "Year 2142. The open internet has fractured. Answers are siloed, questions buried. Stack Overflow — once the last bastion of knowledge — has been sealed behind encrypted firewalls and AI moderation gates.",
    "You are a rogue dev — a codebreaker-for-hire, known only by your handle. The NullPointers have summoned you. They speak of a central system — the Citadel — containing what remains of human-authored knowledge. They believe the old answers still live… hidden deep in forgotten threads.",
    "The Citadel's defense is controlled by the Daemon Mods — AI guardians trained on legacy rep algorithms. They patrol the tag clouds. They delete with prejudice. 'To gain access,' one NullPointer whispers, 'you must answer to the Stack itself...'",
    "A glowing terminal pulses before you. A voice, synthetic but familiar, crackles through the interface: 'To proceed, solve this. Only those worthy of the old ways shall pass.'",
    
    // Challenge begins
    "CHALLENGE_1",
    
    // Post-challenge story continues...
  ...
  function renderChallenge1() {
    ...
    document.getElementById("submit-answer").addEventListener("click", () => {
      ...
      if (answer === "true") {
        resultEl.textContent = "✅ Correct! Moving on...";
  ...
  function renderChallenge3() {
    ...
    document.getElementById("submit-answer3").addEventListener("click", () => {
      ...
      if (answer === "4,16") {
        resultEl.textContent = "🏅 Correct! You've earned the StackQuest Badge!";
